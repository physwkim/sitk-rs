...
//! That is upstream behavior, reproduced here (ledger §2.109).
//!
//! # Sampling
//!
...
//! central-region tests (ledger §2.110).
//!
...
/// (ledger §4.75, and the same deviation `FixedSamples` already documents for

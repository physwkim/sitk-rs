...
use sitk_transform::{AffineTransform, Euler2DTransform, VersorRigid3DTransform};
...
impl LandmarkBasedTransformInitializer {
    ...
    /// ([`sitk_core::matrix::invert`]), which gives the same unique solution
...
fn jacobi_eigen_symmetric(a_in: &[f64], n: usize) -> (Vec<f64>, Vec<f64>) {

...
//! [`crate::fft_correlation`] and ledger §2.94.
//!
//! # Precision
//!
...
mod tests {
    ...
    /// behaviour the filter's own doc-comment denies (ledger §2.93).
    #[test]

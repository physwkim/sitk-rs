...
//! yaml's values are what [`crate::label_map::binary_image_to_label_map`]
//! round-trips against.
//!
...
//! [`crate::label_map::label_unique_label_map`] exists to remove — and this
...
use crate::label_map::{object_offsets, require_label_pixel_id, strides};
...
mod tests {
    ...
    use crate::label_map::{BinaryImageToLabelMapSettings, binary_image_to_label_map};
    use sitk_core::{LabelObject, PixelId};

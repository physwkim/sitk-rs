...
//! netlib `lbfgs.c`/`lbfgsb.c` that [`crate::registration::LBFGSBOptimizer`] ports. Unlike
...
//! [`LBFGSBOptimizer`](crate::registration::LBFGSBOptimizer), this optimizer does not track
...
impl LBFGS2Optimizer {
    ...
    /// best-ever point the way [`LBFGSBOptimizer`](crate::registration::LBFGSBOptimizer)
    /// does).
    ///

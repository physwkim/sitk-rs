...
//! cheap. A [`DisplacementFieldTransform`](crate::transform::DisplacementFieldTransform)
...
//!
//! [`ParametricTransform::has_local_support`]: crate::transform::ParametricTransform::has_local_support

use crate::transform::ParametricTransform;

use crate::registration::metric::{SplitMix64, local_support_block};
...
mod tests {
    use super::*;
    use crate::transform::{AffineTransform, DisplacementFieldTransform, TranslationTransform};

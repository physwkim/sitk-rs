...
//! ```
//! use sitk::core::Image;
//! use sitk::registration::{EstimateLearningRate, ImageRegistrationMethod};
//! use sitk::transform::{ParametricTransform, TranslationTransform};
//!
...
//!
//! [`AffineTransform`]: crate::transform::AffineTransform
//! [`TranslationTransform`]: crate::transform::TranslationTransform
//! [`ScalesEstimator`]: crate::registration::ScalesEstimator

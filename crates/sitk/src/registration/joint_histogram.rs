...
//!
//! Like [`MattesMutualInformationMetric`](crate::registration::MattesMutualInformationMetric)
...
//!
//! [`MattesMutualInformationMetric`]: crate::registration::MattesMutualInformationMetric

use crate::core::Image;
use crate::core::compensated::CompensatedSum;
#[cfg(test)]
use crate::core::compensated::neumaier_sum;
use crate::transform::ParametricTransform;

use crate::registration::error::{RegistrationError, Result};
use crate::registration::metric::{FixedRangeScope, FixedSamples, MetricValue, MovingImage};
...
/// imported from [`crate::registration::mattes`], which has its own private `PADDING` for
...
/// [`RegistrationError::TooFewHistogramBins`](crate::registration::error::RegistrationError::TooFewHistogramBins)
...
/// means to add. Compare [`crate::registration::mattes`]'s `joint_pdf_sum`, which walks the same terms
...
mod tests {
    use super::*;
    use crate::registration::metric::SamplingStrategy;
    ...
    fn gradient_descent_recovers_a_translated_blob() {
        ...
        let opt = crate::registration::optimizer::GradientDescentOptimizer::new(1.0, 200);
    ...
    fn the_jhmi_fixed_axis_is_scoped_to_the_whole_image_even_under_sampling() {
        ...
        let mattes = |fs: FixedSamples| {
            crate::registration::mattes::MattesMutualInformationMetric::from_samples(
                fs,
                MovingImage::from_image(&moving_img).unwrap(),
                20,
            )

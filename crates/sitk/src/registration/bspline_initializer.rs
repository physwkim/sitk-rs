...
//! already ported at
//! [`BSplineTransform::from_image_initializer`](crate::transform::BSplineTransform::from_image_initializer);
...
//! `execute` has no such cap (ledger §4.44, alongside the order restriction
//! above).
//!
//! ```
//! use sitk::core::Image;
//! use sitk::registration::BSplineTransformInitializer;
//!
...
mod tests {
    ...
    fn zero_mesh_size_surfaces_transform_error() {
        ...
        assert!(matches!(
            err,
            RegistrationError::Transform(crate::transform::TransformError::InvalidBSplineDomain)
        ));
    }
}

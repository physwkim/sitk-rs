...
impl MattesGeometry {
    ...
    #[cfg(feature = "cuda")]
    pub(crate) fn device_bins(&self) -> crate::cuda::MattesBins {
        crate::cuda::MattesBins {
            bins: self.num_bins,
            padding: PADDING,
...
/// until this existed.
///
/// The recurrence lives in [`crate::core::compensated::CompensatedSum`], which is ITK's
...
impl MattesMutualInformationMetric {
    ...
    /// [`sparse_jacobian_wrt_parameters`]: ParametricTransform::sparse_jacobian_wrt_parameters
    /// [`BSplineTransform`]: crate::transform::BSplineTransform
    /// [`BSplineTransform::sparse_jacobian_wrt_parameters`]: crate::transform::BSplineTransform
    /// [`DisplacementFieldTransform`]: crate::transform::DisplacementFieldTransform
...
mod tests {
    ...
    fn bspline_derivative_matches_finite_difference() {
        ...
        use crate::transform::{BSplineTransform, ParametricTransform};
    ...
    fn displacement_field_case() -> (
        ...
        crate::transform::DisplacementFieldTransform,
    ) {
        use crate::transform::{DisplacementFieldTransform, ParametricTransform};
    ...
    fn bspline_sparse_support_counts_samples_outside_its_valid_region() {
        ...
        use crate::transform::{BSplineTransform, ParametricTransform, TransformBase};

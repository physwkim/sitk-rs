...
pub enum RegistrationError {
    ...
    /// crate::registration::ImageRegistrationMethod::execute_with_initial_transform
    /// [`set_initial_transform`]: crate::registration::ImageRegistrationMethod::set_initial_transform
    ...
    /// crate::registration::ImageRegistrationMethod::set_initial_transform_as_bspline
    ...
    /// [`crate::transform::BSplineTransform`] implements. SimpleITK's own
    ...
    /// matching [`crate::transform::BSplineTransform::new`]'s own established
    /// convention.

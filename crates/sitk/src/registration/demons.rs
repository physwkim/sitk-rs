...
//! convention [`mattes`](crate::registration::mattes) and [`metric`](crate::registration::metric) already
...
//! path the way [`MattesMutualInformationMetric`](crate::registration::mattes) does for a
...
//! [`local_support_block`](crate::registration::metric) path — there is no dense branch in
...
//! [`SetMetricAsDemons`]:
//! <https://github.com/SimpleITK/SimpleITK/blob/main/Code/Registration/include/sitkImageRegistrationMethod.h>
//! [`metric::CpuBackend::mean_squares`]: crate::registration::metric::CpuBackend

use crate::core::Image;
use crate::transform::ParametricTransform;

use crate::registration::error::{RegistrationError, Result};
use crate::registration::metric::{FixedSamples, MetricValue, MovingImage, local_support_block};

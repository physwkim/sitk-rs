...
//! update ([`crate::filters::denoise::curvature_flow`], whose
...
//!   [`crate::filters::denoise::curvature_flow`]'s on the same image — exact only at
...
//!   [`crate::filters::denoise::curvature_flow`] already rejects steps outside
...
mod tests {
    use super::*;
    use crate::filters::denoise::curvature_flow;

//! Crate-private complex DFT, the transform behind [`crate::filters::fourier`],
//! [`crate::filters::convolution::fft_convolution`], [`crate::filters::deconvolution`],
//! [`crate::filters::fft_correlation`] and `N4BiasFieldCorrection`'s `SharpenImage`.
//!
...
//! [`crate::filters::fft_correlation`] and ledger §2.110.
//!
//! # Precision
//!
...
/// [`crate::core::Complex`], and no value of this type escapes `sitk-filters`.

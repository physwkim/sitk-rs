...
//! needed here: [`crate::core::LabelMap`] is already a distinct type, not an
//! [`Image`] (`doc/upstream-findings.md` §4.25) — a caller hashes a label
//! map by calling
//! [`LabelMap::to_label_image`](crate::core::LabelMap::to_label_image) first
...
/// [`crate::filters::stable_time_step_bound`]/[`crate::filters::fast_marching::large_value`]).
...
/// to this module rather than added to [`crate::core::Scalar`] — hashing is

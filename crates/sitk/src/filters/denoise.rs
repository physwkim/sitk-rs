...
use crate::filters::gradient::derivative_operator_coefficients;
...
pub fn mean(img: &Image, radius: &[usize]) -> Result<Image> {
    ...
    /// volume. The window is borrowed ([`crate::core::WindowView`]) and the result
...
pub fn discrete_gaussian(
    ...
    Ok(crate::core::map_pixels(&smoothed, img.pixel_id(), |v| v)?)
}
...
/// below. Reproduced as-is; see [`crate::core::compensated::CompensatedSum::seeded`].
...
/// [`crate::core::Neighborhood::values`] holds — it is the same enumeration
...
/// [`crate::filters::min_max_curvature_flow`], which reuses this update unchanged.
///
...
/// voxel, including the sweeps below and in [`crate::filters::anisotropic_diffusion`] and
/// [`crate::filters::min_max_curvature_flow`], which all already held a borrowed
/// [`crate::core::WindowView`] and copied it only to satisfy this signature.
...
mod tests {
    ...
    fn integer_intermediates_are_carried_at_full_precision() {
        ...
        for (i, &r) in real_out.to_f64_vec().unwrap().iter().enumerate() {
            assert_eq!(
                f64::from(int_vals[i]),
                crate::filters::quantize_to_pixel_type(PixelId::Int32, r),
...
/// ([`crate::filters::stencil_test_support::window_sum_order_is_observable`]), and it is
...
mod gaussian_derivative_thread_parity {
    use super::*;
    use crate::core::parallel;
    use crate::filters::stencil_test_support::{

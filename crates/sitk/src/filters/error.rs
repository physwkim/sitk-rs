...
pub enum FilterError {
    ...
    /// `RankImageFilter`'s port ([`crate::filters::rank::rank`]): the structuring
    ...
    /// refuses the crop instead — see [`crate::filters::label_map_mask`]'s upstream
    /// finding 3.
    ...
    /// [`crate::filters::objectness::objectness_measure`] diagonalizes the Hessian with

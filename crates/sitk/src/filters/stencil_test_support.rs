...
//! `iter().map().collect()` to a [`crate::core::NeighborhoodIterator`] window pass
...
/// A 32³ volume — 32 768 voxels, above `crate::core::parallel`'s 16 384 serial
...
pub(crate) fn window_sum_order_is_observable(img: &Image, radius: &[usize]) -> bool {
    use crate::core::{NeighborhoodIterator, ZeroFluxNeumannBoundaryCondition};

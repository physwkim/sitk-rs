...
use super::grid::Grid;
use crate::filters::denoise::curvature_flow_update_at;
...
impl CurvatureFlowFunction {
    ...
    /// [`crate::filters::denoise::curvature_flow`] through
...
/// [`crate::filters::denoise::curvature_flow_update`] must return **bit-identical** `f64`
...
/// [`crate::core::WindowView`] and through an owned [`crate::core::Neighborhood`].
...
mod seam_parity {
    ...
    use crate::filters::denoise::curvature_flow_update;
    use crate::filters::level_set::grid::Grid;

...
//! with the same defaults [`crate::filters::convolution::fft_convolution`] uses, as each
...
/// Validates the kernel exactly as [`crate::filters::convolution::fft_convolution`] does
/// — same [`crate::filters::error::FilterError`] variants for a dimension mismatch, a
...
mod tests {
    use super::*;
    use crate::filters::convolution::fft_convolution;

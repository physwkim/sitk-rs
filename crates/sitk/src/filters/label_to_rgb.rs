...
/// Unlike [`crate::filters::require_same_shape`], `image` and `label_image` may
...
/// The vector-image counterpart of `crate::filters::image_from_f64`: narrows `vals`
...
pub fn label_overlay(
    ...
    let value_max = crate::filters::numeric_traits_max(base_id);

...
use crate::core::{Image, LabelMap, LabelObject, LabelObjectLine, MAX_DIM, PixelId};

use crate::filters::error::{FilterError, Result};
use crate::filters::label::{create_consecutive, scanline_components};
...
mod tests {
    ...
    fn binary_image_to_label_map_agrees_with_connected_component_on_a_zero_one_image() {
        ...
        let (map, _) = binary_image_to_label_map(&img, &Default::default()).unwrap();
        let cc = crate::filters::label::connected_component(&img, None, false).unwrap();

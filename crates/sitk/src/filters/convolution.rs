...
/// `crate::core::boundary` implementation.
...
pub(crate) struct PaddedInput {
    ...
    /// accepts at `SizeGreatestPrimeFactor == 11` (`crate::filters::fft::padded_length`).
...
/// crate's own mixed-radix DFT (`crate::filters::fft`), and the padding is

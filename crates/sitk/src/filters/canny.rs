...
//! *unflipped* coefficients, unlike this crate's [`crate::filters::gradient::derivative`]
...
use crate::core::{Image, NeighborhoodIterator, PixelId, ZeroFluxNeumannBoundaryCondition};
...
/// borrowed [`crate::core::WindowView`] instead of a per-voxel `Neighborhood` copy.
...
/// buffer for [`zero_crossing`] (matching [`crate::filters::gradient`]'s own
/// `scratch_f64` helper).

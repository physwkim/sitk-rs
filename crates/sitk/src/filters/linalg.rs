...
/// 3-dimensional.
///
/// Aliased to [`crate::core::MAX_DIM`] rather than redeclared, because
/// `label_shape.rs` indexes [`crate::core::LabelObjectLine`]'s start index with
/// it: one definition, so the two can never drift apart.
pub(crate) use crate::core::MAX_DIM;

...
//! slice, matching [`crate::filters::grid_utility::tile`].
//!
//! ## `staple`
//!
...
//! ## Precision note
//!
//! Label values are read through [`crate::core::Image::to_f64_vec`] and rounded
...
//! label filters ([`crate::filters::overlap`], [`crate::filters::label`]) take the same route.

...
//! [`crate::filters::relabel_component`] afterwards if contiguity is needed.
//!
...
mod tests {
    ...
    fn constant_image_yields_the_pure_grid() {
        ...
        assert_eq!(out.labels.pixel_id(), crate::core::PixelId::UInt32);
    ...
    fn too_few_grid_entries_is_rejected() {
        let img = Image::new(&[8, 8], crate::core::PixelId::Float64);
        assert!(matches!(

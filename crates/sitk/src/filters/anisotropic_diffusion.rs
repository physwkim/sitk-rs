...
//! themselves. This diverges from [`crate::filters::curvature_flow`], which rejects an
...
/// apply to it — unlike [`crate::filters::min_max_curvature_flow`]'s sweep, there is no
...
mod stencil_thread_parity {
    ...
    use crate::core::{Neighborhood, parallel};

...
//!   `TMask{}`, i.e. **0**. This is the convention of [`crate::filters::label::connected_component`]
//!   (which runs its input through `MaskImageFilter` verbatim,
//!   `itkConnectedComponentImageFilter.hxx:79-92`) and of
//!   [`crate::filters::scalar_connected_component`] (whose functor filter open-codes the same test,
...
//!   [`crate::filters::histogram::ThresholdMask`].
//!

...
use crate::filters::convolution::{ravel, unravel};
...
/// infinity. Matches this crate's [`crate::filters::DivOp`] for float pixel types.
...
mod tests {
    ...
    fn find_closest_valid_dimension_accepts_only_two_three_and_five() {
        ...
        assert_eq!(crate::filters::fft::padded_length(49), 49);
        ...
        for n in [1usize, 8, 12, 100, 128] {
            ...
            assert_eq!(crate::filters::fft::padded_length(n), n);
        }
    }

...
mod group1_functors {
    use super::*;
    use sitk::filters::{add, and, equal, greater, mask, modulus, multiply, subtract};
    ...
    fn exempt_histogram_matching_still_accepts_a_shifted_reference() {
        ...
        let out = sitk::filters::histogram_matching(&base(), &reference, 64, 8, false);
        assert!(
            out.is_ok(),
...
mod group3_compose {
    use super::*;
    use sitk::filters::complex::real_and_imaginary_to_complex;
    use sitk::filters::{ConvolutionBoundaryCondition, OutputRegionMode, compose, convolution};
...
mod group5_labels {
    use super::*;
    use sitk::filters::deconvolution::inverse_deconvolution;
    use sitk::filters::label_intensity::{
...
mod group6_label_fusion {
    use super::*;
    use sitk::filters::label_fusion::{label_voting, multi_label_staple, staple};
    use sitk::filters::tile;
...
mod group11_n4_confidence {
    use super::*;
    use sitk::filters::{N4BiasFieldCorrectionSettings, n4_bias_field_correction, paste};

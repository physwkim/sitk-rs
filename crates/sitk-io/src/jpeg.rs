...
//! [`WriteOptions::use_compression`]. Ledger §2.139.
//!
...
//! mixed-case spelling such as `.Jpg` still fails. Ledger §2.138.
//!
//! # Not implemented
//!
...
mod tests {
    ...
    fn resolved_quality_ignores_use_compression() {
        // m_UseCompression is dead code (ledger §2.139): on or off, an

...
/// (gzio.c:516), so the raw bytes come straight through (ledger §2.94).
#[test]
...
/// writes gzip anyway (itkNiftiImageIO.cxx:1173; ledger §3.33).
#[test]
...
/// holding an uncompressed NIfTI reads (ledger §2.94). The converse also holds:
